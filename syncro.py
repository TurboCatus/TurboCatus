#! /usr/bin/python3
import os
p=os.system('ping -c 3 192.168.1.5 > ping.txt') #ping ip address
...
port=os.system('nmap 192.168.1.5 > port.txt') # test port
pp=open('port.txt')
ppp=pp.read()
if p in ppp:
  os.system('echo port_open >> log_sync.txt')
if c not in a:
...
if (c in b) and (p in ppp):
    ...
    os.system(' rsync -avzhe "ssh -p 8022" Linux@192.168.1.5:/data/data/com.termux/files/home/storage/shared/Android/media/com.whatsapp/WhatsApp/Media/ /media/lubuntu/cecdbebf-1288-4fcc-9e7e-c59f15bf5af8/Phone_back/ >> log_sync.txt 2>&1') #log syncro
